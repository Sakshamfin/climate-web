...
function Landing() {
  ...
  const handleCityByCordinates = useCallback(async (lat: number, lon: number) => {
    await api
      .get(
        `?lat=${lat}&lon=${lon}&appid=e81965343df414cbfb25d98c8741fe2a&lang=pt_br&units=metric`
      )
      .then(response => {
        setValid(true);
  ...
  }, [handleCityByCordinates, setLocation]);
  ...
  }, [location, getLocation, handleCityByCordinates]);
  ...
  async function handleCity(e: FormEvent) {
    ...
    await api
      .get(`?q=${city}&appid=e81965343df414cbfb25d98c8741fe2a&lang=pt_br&units=metric`)
      .then(response => {
        setData(response.data);
      })
      .catch(() => {
    ...
    <div id="main">
      ...
      <div className="main-grid">
          ...
          <div className="content">
            <div className="principal">
                ...
                <form onSubmit={handleCity}>
                  <div className="extras">
                    <div className="get-location" onClick={getLocation}>
                      <span className="get-location-button">Minha localização</span>
                    </div>
                    {!valid && <span className="snackbar">Cidade inválida</span>}
                  </div>
              ...
              <div className="result">
                <img src={icon} alt="Clima" className="weather-icon" />
        ...
        <div className="credits">
          by&nbsp;
          <a
            href="https://github.com/joaovictornsv"
            target="_blank"
            rel="noopener noreferrer"
          >
